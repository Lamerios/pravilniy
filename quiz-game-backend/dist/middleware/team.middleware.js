...
exports.validateTableNumber = exports.validateTeamId = exports.validateTeamQueryParams = exports.validateTeamData = exports.validateTeamQuery = exports.validateUpdateTeam = exports.validateCreateTeam = void 0;
const validation_middleware_1 = require("./validation.middleware");
exports.validateCreateTeam = (0, validation_middleware_1.createValidationMiddleware)(validation_middleware_1.teamValidationSchemas.createTeam);
exports.validateUpdateTeam = (0, validation_middleware_1.createValidationMiddleware)(validation_middleware_1.teamValidationSchemas.updateTeam);
exports.validateTeamQuery = (0, validation_middleware_1.createQueryValidationMiddleware)(validation_middleware_1.teamValidationSchemas.teamQuery);
...
exports.validateTeamData = validateTeamData;
const validateTeamQueryParams = (req, res, next) => {
...
exports.validateTeamQueryParams = validateTeamQueryParams;
...
exports.validateTeamId = validateTeamId;
...
exports.validateTableNumber = validateTableNumber;
//# sourceMappingURL=team.middleware.js.map