# 🎯 Правильный Квиз - Документация для разработки
...
### Что это?
Правильный Квиз - система управления интеллектуальными играми с real-time табло и автоматическим подсчетом баллов.
